  ...
  return (
    <section className="relative overflow-x-hidden " >
      <Container>
        ...
        <div className="flex flex-col   3xl:flex-row 4xl:w-[1560px] gap-[80px] mb-[178.87px]">
          <div>
            <h2
              className="text-[#FFF] text-center 3xl:text-left text-[28px] xl:text-[56px] font-semibold leading-[120%]"
              data-aos="fade-right"
            >
              Transforming the Way You Build <br /> Praxon AI
            </h2>
            {/* {/ 4+ Years Expericed Card /} */}
            <div className="flex flex-wrap items-center justify-center 3xl:items-start 3xl:justify-start gap-6 mx-auto mt-[75px]">
              <div
        ...
        <div className="flex flex-col gap-y-12  justify-center  3xl:flex-row 3xl:gap-[150px] 4xl:gap-[96px] mt-[350px] mb-[443.84px] sm:mb-[243px] 3xl:mb-[100px] 4xl:w-[1600px] h-[523px] ">
          ...
          <div className="flex flex-col items-center ">
            ...
            <p
              ...
              data-aos-delay="100"
            >
              At Praxon AI, we believe that our collective <br /> strength lies
              in shared values. These core principles <br /> guide how we work
          ...
          <div className="relative flex flex-col w-full 2xl:justify-center 2xl:items-center ">
            ...
            <div
              className="2xl:w-[1018.6px] 3xl:w-[800px] 4xl:w-[1018.6px]  h-auto 2xl:h-[135px] bg-[#131023] rounded-3xl mb-6"
              data-aos="fade-up"
              data-aos-delay="100"
            >
            ...
            <div
              className="2xl:w-[1018.6px] 3xl:w-[800px] 4xl:w-[1018.6px] h-auto 2xl:h-[105.59px] bg-[#3C365F] rounded-3xl mb-6"
              data-aos="fade-up"
              data-aos-delay="200"
            >
              <div className="flex flex-col 2xl:flex-row pt-[24px] pb-[24px] pl-[32px] pr-[32px] gap-4 flex-1">
            ...
            <div
              className="2xl:w-[1018.6px] 3xl:w-[800px] 4xl:w-[1018.6px] h-auto 2xl:h-[105.59px] bg-[#1D1935] rounded-3xl mb-6"
              data-aos="fade-up"
              data-aos-delay="300"
            >
              <div className="flex flex-col 2xl:flex-row pt-[24px] pb-[24px] pl-[32px] pr-[32px] gap-4 flex-1">
