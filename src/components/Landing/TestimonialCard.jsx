...
function TestimonialCard({ item }) {
  return (
    <div className=" mr-[6px] ml-[6px] 2xl:custom-wrap">
      <div className="xl:py-8 py-4 xl:px-6 px-3 xl:w-[545px] bg-faqBg rounded-[24px] border border-cardBorderColor flex items-start gap-4 relative">
        ...
        <div>
          <h3 className=" text-[14px] w-[250px] xl:w-auto xl:text-[20px] font-bold text-white">{item?.title}</h3>
